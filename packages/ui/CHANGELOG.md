...
* docs: update remote setup guide with full operational checklist ([71201ea](https://github.com/fubaritico/vite-mf-monorepo-tmdb/commit/71201ea))
...
* docs: update session state with recent completed work ([3c22ea0](https://github.com/fubaritico/vite-mf-monorepo-tmdb/commit/3c22ea0))
...
* docs(layouts): update changelog for version bump ([a809986](https://github.com/fubaritico/vite-mf-monorepo-tmdb/commit/a809986))
* docs(layouts): update changelog for version bump ([cd32eb0](https://github.com/fubaritico/vite-mf-monorepo-tmdb/commit/cd32eb0))
...
* docs(shared): update changelog for version bump ([fbddb44](https://github.com/fubaritico/vite-mf-monorepo-tmdb/commit/fbddb44))
...
* docs(ui): update changelog for version bump ([f9aa069](https://github.com/fubaritico/vite-mf-monorepo-tmdb/commit/f9aa069))
* docs(ui): update changelog for version bump ([0d15613](https://github.com/fubaritico/vite-mf-monorepo-tmdb/commit/0d15613))
* docs(ui): update changelog for version bump ([6a9892f](https://github.com/fubaritico/vite-mf-monorepo-tmdb/commit/6a9892f))
* docs(ui): update changelog for version bump ([a092f74](https://github.com/fubaritico/vite-mf-monorepo-tmdb/commit/a092f74))
...
* chore: added modification in host to trigger redeploy ([f67cd36](https://github.com/fubaritico/vite-mf-monorepo-tmdb/commit/f67cd36))
* chore: added modification in host to trigger redeploy ([90c6ac2](https://github.com/fubaritico/vite-mf-monorepo-tmdb/commit/90c6ac2))
...
* ci(host): add VITE_SEARCH_URL to deploy-host workflow ([7b45ded](https://github.com/fubaritico/vite-mf-monorepo-tmdb/commit/7b45ded))
...
* feat(search): scaffold remote app ([3ac0151](https://github.com/fubaritico/vite-mf-monorepo-tmdb/commit/3ac0151))
...
* feat(ui): add Input component with icon, label, and message support ([dc067e8](https://github.com/fubaritico/vite-mf-monorepo-tmdb/commit/dc067e8))
* feat(ui): add Menu compound component with keyboard nav and dark variant ([441f0ab](https://github.com/fubaritico/vite-mf-monorepo-tmdb/commit/441f0ab))
...
* feat(ui): add portal option to Typeahead dropdown menu ([1280564](https://github.com/fubaritico/vite-mf-monorepo-tmdb/commit/1280564))
...
* feat(ui): add Typeahead compound component with keyboard nav and highlight ([9a2bd56](https://github.com/fubaritico/vite-mf-monorepo-tmdb/commit/9a2bd56))
...
* fix(hero): fixed hero components behavior on resize ([dc96732](https://github.com/fubaritico/vite-mf-monorepo-tmdb/commit/dc96732))
...
* fix(storybook): just to trigger the deploy ([05f1782](https://github.com/fubaritico/vite-mf-monorepo-tmdb/commit/05f1782))
...
* fix(ui,layouts): replace tsup DTS worker with tsc to fix OOM ([3f2916a](https://github.com/fubaritico/vite-mf-monorepo-tmdb/commit/3f2916a))
...
* refactor(media): merge Crew section into MediaHero ([d3944ac](https://github.com/fubaritico/vite-mf-monorepo-tmdb/commit/d3944ac))
...
* refactor(ui): extract ListboxList/ListboxItem and compose in Menu ([2c15694](https://github.com/fubaritico/vite-mf-monorepo-tmdb/commit/2c15694))
...
* refactor(ui): simplify Portal with useState and proper cleanup ([7e780da](https://github.com/fubaritico/vite-mf-monorepo-tmdb/commit/7e780da))
